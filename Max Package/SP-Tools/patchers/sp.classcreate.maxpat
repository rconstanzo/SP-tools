...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 679.055555555555543, 129.236363636363649, 55.0, 22.0 ],
					"text" : "s #0train"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 466.0, 213.589522266666677, 87.0, 22.0 ],
									"text" : "s #0mlptrained"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 391.0, 213.589522266666677, 55.0, 22.0 ],
									"text" : "r #0clear"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 241.0, 213.589522266666677, 129.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 241.0, 256.486902833333374, 418.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 758.0, 216.727272727272748, 76.0, 22.0 ],
					"text" : "r #0classifier"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 840.833333333333258, 129.236363636363649, 78.0, 22.0 ],
					"text" : "s #0classifier"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 607.0, 391.709090909090946, 53.0, 22.0 ],
					"text" : "r #0print"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 517.277777777777828, 172.981818181818198, 55.0, 22.0 ],
					"text" : "s #0print"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 662.0, 391.709090909090946, 55.0, 22.0 ],
					"text" : "r #0clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 999.0, 347.963636363636397, 55.0, 22.0 ],
					"text" : "r #0clear"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 424.0, 304.218181818181847, 57.0, 22.0 ],
					"text" : "s #0clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 963.0, 391.709090909090946, 193.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 801.999999999999886, 36.5, 53.0, 22.0 ],
									"text" : "r #0train"
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 58.5, 260.472727272727298, 129.0, 22.0 ],
					"text" : "fit #0classifier #0labels"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 58.5, 304.218181818181847, 190.0, 22.0 ],
					"text" : "fluid.knnclassifier~ #0knnclassifier"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 498.5, 435.454545454545496, 144.0, 22.0 ],
					"text" : "fluid.labelset~ #0labels"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 758.0, 391.709090909090946, 190.0, 22.0 ],
					"text" : "fluid.knnclassifier~ #0knnclassifier"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 310.0, 435.454545454545496, 157.0, 22.0 ],
					"text" : "fluid.dataset~ #0classifier"
				}
